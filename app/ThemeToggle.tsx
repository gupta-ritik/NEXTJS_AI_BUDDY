...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-5 w-9 rounded-full bg-slate-800/80 border border-slate-600 flex items-center px-1">
        <div
          ref={knobRef}
          className="h-3.5 w-3.5 rounded-full bg-gradient-to-tr from-amber-300 to-amber-100 shadow-md shadow-amber-400/40 flex items-center justify-center text-[9px]"
        >
          {isDark ? "🌙" : "☀️"}
        </div>
      </div>
