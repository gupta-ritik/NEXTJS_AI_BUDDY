      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">
            <span className="text-scramble" data-scramble-text="Set up your">
              Set up your
            </span>
          ...
          <div className="mt-3 h-6">
            <svg viewBox="0 0 200 40" className="h-full w-40 text-indigo-300/80" aria-hidden="true">
              <path
              ...
              <div className="relative card-soft rounded-3xl border border-slate-800 bg-slate-950/80 backdrop-blur-xl p-8 shadow-2xl">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">It only takes a minute to get started.</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    />
                    <p className="text-[11px] text-slate-500">Optional, used for account context and support only.</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-xl border border-slate-800 bg-slate-900/60 px-3 py-2 text-sm uppercase tracking-wider outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40"
                      value={referralCode}
                      onChange={(e) => setReferralCode(e.target.value)}
                    />
                    <p className="text-[11px] text-slate-500">Have a friend&apos;s invite? Enter it to get bonus credits.</p>
                  </div>
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-medium text-slate-300 mt-1 block">Confirm password</label>
                    ...
                    <div className="relative">
                      ...
                      {confirm && (
                        <span className="absolute right-2.5 top-2.5 text-xs">{passwordsMatch ? "✅" : "❌"}</span>
                      )}
                    </div>
                  </div>
          ...
          {success && (
            ...
            >
              ...
              <div className="relative card-soft bg-slate-950/80 rounded-3xl p-10 text-center shadow-2xl border border-slate-800">
                ...
                <p className="text-slate-400 mt-2 text-sm">You&apos;ll be redirected to login in a moment.</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
